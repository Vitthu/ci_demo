...
<html lang="en">
    ...
    <body class=" login" style="background: #8a8d8f">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <a href="<?php echo base_url() ?>">
                <img src="<?php echo base_url() ?>assets/custom/images/logo.png" style="height: 74px;" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" id="login-form" action="<?php echo $action ?>" method="post">
                <div class="form-title">
                    <!--<span class="form-title">Welcome.</span>-->
                    <span class="form-subtitle">Please login.</span>
                </div>
                <div class="alert alert-danger <?php echo isset($error) ? '' : 'display-hide' ?>">
...
<!--                    <div class="pull-right forget-password-block">
            ...
            <?php /*     <form class="register-form" action="index.html" method="post">
              <div class="form-title">
        ...
        <div class="copyright"><?php echo date('Y'); ?> &copy; AskMeAnyThing Pvt. Ltd. </div>
        <!-- END LOGIN -->
        <!--[if lt IE 9]>
