...
<div style="width:100%;clear:both;">
    <div style="">
    <p style="font-size:12px;margin-top:0px;color:#000;font-family:arial;">Your login Credentials are</p> 
	Username : <span style="color:#000;"><?php echo $email_id;?></span></br>
    Password : <span style="color:#000;"><?php echo $password;?></span>
