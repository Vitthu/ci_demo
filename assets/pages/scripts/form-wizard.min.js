                ...
                $("#form_wizard_1").bootstrapWizard({
					...
					$.ajax({
						...
						success: function (res) {
							...
							if (res.error) {
								$("#flash2").show();
								$("#flash2").html("<div class='alert alert-danger'>" + res.error + "<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>");
								$("#flash2").delay(4000).fadeOut(300);
							}
						}
					});
					return false;
